...
/* harmony import */ var _modules_searchMovies__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/searchMovies */ "./src/modules/searchMovies.js");

(0,_modules_searchMovies__WEBPACK_IMPORTED_MODULE_0__["default"])();
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var card = function card(moviePoster, movieTitle, movieYear, movieImdbId) {
  return "\n        <img class=\"card-img-top\" src=\"".concat(moviePoster, "\" alt=\"").concat(movieTitle, "\">\n        <div class=\"card-body\">\n            <h5 class=\"card-title\">").concat(movieTitle, "</h5>\n            <p>Year: ").concat(movieYear, "</p>\n            <a href=\"#\" class=\"movie-id-link\" id=\"").concat(movieImdbId, "\">More...</a>\n        </div>\n        ");
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (card);

/***/ }),

/***/ "./src/modules/displayMovieById.js":
/*!*****************************************!*\
  !*** ./src/modules/displayMovieById.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var displayMovieById = function displayMovieById(cardTargetId, movieResultBody) {
  //Catches the id of <a> element and displays only one movie with plot=full details
  cardTargetId.querySelector('.movie-id-link').addEventListener('click', /*#__PURE__*/function () {
    var _ref = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(movieId) {
      var singleMovieBody, getMovieId, m;
        ...
        while (1) switch (_context.prev = _context.next) {
          ...
          case 5:
            ...
            if (m.Response == 'True') {
              ...
              //Creates the id
              singleMovieBody.innerHTML = (0,_moviePage__WEBPACK_IMPORTED_MODULE_1__["default"])(m.Title, m.Year, (0,_calcTime__WEBPACK_IMPORTED_MODULE_3__["default"])(m.Runtime), m.Rated, m.imdbRating, m.Poster, m.Director, m.Genre, m.Actors, m.Country, m.Awards, m.Plot);
            }
            ...
            document.querySelector('.btn-return').addEventListener('click', function () {
              ...
              var storedMovies = JSON.parse(localStorage.getItem('movieStorage'));
              (0,_returnFromStorage__WEBPACK_IMPORTED_MODULE_2__["default"])(storedMovies, movieResultBody);
            });
          case 9:
          case "end":
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (displayMovieById);

/***/ }),

/***/ "./src/modules/moviePage.js":
/*!**********************************!*\
  !*** ./src/modules/moviePage.js ***!
  \**********************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
var moviePage = function moviePage(movieTitle, movieYear, movieRated, movieRuntime, movieImdb, moviePoster, movieDirector, movieGenre, movieActors, movieCountry, movieAwards, moviePlot) {
  return "\n    <div class=\"row movie-info-return\">\n        <div class=\"col movie-info\">\n            <div class=\"col movie-title\">\n                <h1>".concat(movieTitle, "</h1>\n            </div>\n            <div class=\"col movie-small-info\">\n                <p>").concat(movieYear, "</p>\n                <p>").concat(movieRated, "</p>\n                <p>").concat(movieRuntime, "</p>\n                <p><i class=\"bi bi-star\"></i> ").concat(movieImdb, "/10</p>\n            </div>\n        </div>\n        <div class=\"col movie-return\">\n            <i class=\"bi bi-arrow-left btn-return\"></i>\n        </div>\n    </div>\n    <div class=\"row movie-details\">\n        <div class=\"col movie-poster\">\n            <img src=\"").concat(moviePoster, "\" alt=\"\">\n        </div>\n        <div class=\"col movie-credits\">\n            <ul>\n                <li>Director: ").concat(movieDirector, "</li>\n                <li>Genre: ").concat(movieGenre, "</li>\n                <li>Actors: ").concat(movieActors, "</li>\n                <li>Country: ").concat(movieCountry, "</li>\n                <li>Awards: ").concat(movieAwards, "</li>\n                <li>").concat(moviePlot, "</li>\n            </ul>\n        </div>\n    </div>\n    ");
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (moviePage);

/***/ }),

/***/ "./src/modules/returnFromStorage.js":
/*!******************************************!*\
  !*** ./src/modules/returnFromStorage.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _displayMovieById__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./displayMovieById */ "./src/modules/displayMovieById.js");
/* harmony import */ var _card__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./card */ "./src/modules/card.js");


var returnFromStorage = function returnFromStorage(storedMovies, movieResultBody) {
  storedMovies.forEach(function (item) {
    var cardElement = document.createElement('div');
    cardElement.className = "card";
    cardElement.innerHTML = (0,_card__WEBPACK_IMPORTED_MODULE_1__["default"])(item.Poster, item.Title, item.Year, item.imdbID);
    movieResultBody.appendChild(cardElement);
    (0,_displayMovieById__WEBPACK_IMPORTED_MODULE_0__["default"])(cardElement, movieResultBody);
  });
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (returnFromStorage);
...
var searchMovie = function searchMovie() {
  document.querySelector('.input-button').addEventListener('click', /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    var movieResultBody, searchMovieInput, singleMovieBody, searchResult, cardElement;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          movieResultBody = document.querySelector('main article .card-container');
        ...
        case 5:
          ...
          if (searchResult.Response == "True" && searchResult.Search) {
            ...
            movieResultBody.innerHTML = "";
            searchResult.Search.forEach(function (movie) {
              if (movie.Poster == 'N/A') {
                movie.Poster = "/src/scss/img/No_Image_Available.jpg";
              }
              var cardElement = document.createElement('div');
              cardElement.className = "card";
              cardElement.innerHTML = (0,_card__WEBPACK_IMPORTED_MODULE_2__["default"])(movie.Poster, movie.Title, movie.Year, movie.imdbID);
              movieResultBody.appendChild(cardElement);
              //Display one result with more details, fetches the url with plot=full details, catches the imdbid id on <a> element
              (0,_displayMovieById__WEBPACK_IMPORTED_MODULE_1__["default"])(cardElement, movieResultBody);
            });
          } else {
            cardElement = document.createElement('h1');
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkmovieapi0911"] = self["webpackChunkmovieapi0911"] || [];
